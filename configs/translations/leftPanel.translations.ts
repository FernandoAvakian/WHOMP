...
export const layersPanelTranslations = {
  en: {
    ...
    layers: 'Layers',
    description:
      'Select datasets from different categories that you wish to visualize on the map. Metadata and a guidance to interpret layers are also available <a href="https://whc.unesco.org/uploads/activities/documents/activity-1142-20.pdf" target="_blank">here</a>.',
