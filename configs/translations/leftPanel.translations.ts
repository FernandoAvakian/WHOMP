...
export const layersPanelTranslations = {
  en: {
    ...
    layers: 'Layers',
    description:
      'Select datasets from different categories that you wish to visualize on the map. Metadata and a tutorial are also available <a href="https://whc.unesco.org/uploads/activities/documents/activity-1142-19.pdf" target="_blank">here</a>.',
  ...
  fr: {
    ...
    layers: 'Couches',
    description:
      'Sélectionnez des ensembles de données de différentes catégories que vous souhaitez visualiser et ajouter à la carte. Les métadonnées et un tutoriel sont également disponibles <a href="https://whc.unesco.org/uploads/activities/documents/activity-1142-19.pdf">ici</a>.',
